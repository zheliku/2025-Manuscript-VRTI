...
% Furthermore, we develop a hand redirection solution based on gesture prediction and a pre-interaction library to achieve visual-haptic synchronization within the VRTI framework. 
